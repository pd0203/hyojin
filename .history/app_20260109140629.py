...
def approve_edit_request(request_id):
    ...
    try:
        ...
        work_date = str(req['request_date'])  # 문자열로 변환
        new_clock_in = str(req['new_clock_in']) if req['new_clock_in'] else None
        new_clock_out = str(req['new_clock_out']) if req['new_clock_out'] else None
