...
try:
    ...
    if not CURRENT_SETTINGS:
        print("⚠️  경고: playauto_settings_v4.json 파일이 없습니다. 기본 설정을 사용합니다.")
        # 기본 설정
        CURRENT_SETTINGS = {
            "work_order": ["송과장님", "영재씨", "강민씨", "부모님", "합배송", "복수주문", "분류실패"],
            "work_config": {
                "송과장님": {"products": [], "enabled": True},
                "영재씨": {"products": [], "enabled": True},
                "강민씨": {"products": [], "enabled": True},
                "부모님": {"products": [], "enabled": True},
